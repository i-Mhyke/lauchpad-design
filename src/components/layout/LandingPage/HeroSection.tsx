          ...
          <div className="flex flex-col">
            <div className="flex flex-col w-full pt-16 lg:m-0 text-center">
              ...
              <div className="max-w-3xl mx-auto">
                ...
                >
                  We are the leading decentralized cronos-chain launchpad
                  protocol in crypto. <span /> A One-Stop platform to invest in
                  a variety of diversified blockchain projects.
                </h3>
              </div>
              <div className="mb-8">
            ...
            <div>
              <div className="w-full pt-16">
                <img
                  src={dashboardFrame}
                  alt="snapshot showing dashboard on dotlaunch, a crypto launchpad on cronos-chai, best crypto launchpad"
                  // text="dashboard"
