    ...
    >
      <AppContainer>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 pb-16">
          <div className="space-y-5">
            ...
            <div className="flex items-center justify-center space-x-4">
              {/* <img src={dotLogo} alt="safelaunch Logo" /> */}
              <h5 className="font-bold text-lg">
                CUTTING-EDGE <br /> DECENTRALIZED <br /> PROTOCOL
              </h5>
            </div>
            <div className="border-t-4 border-b-4 border-custom-dark-primaryRed py-6 text-center">
              <a className="text-lg" href="mailto:info@safelaunch.io">
                info@safelaunch.io
              </a>
            </div>
            <div className="flex justify-center pt-5">
              <button className="border-2 border-custom-dark-primaryRed px-12 py-5">
                Schedule A Chat
              </button>
            </div>
          </div>
        ...
        <div className="text-center pt-5 text-gray-400">
          <p>
            &#169; {new Date().getFullYear()} safelaunch. All rights reserved
          </p>
        </div>
      </AppContainer>
    </div>
